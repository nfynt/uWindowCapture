...
namespace uWindowCapture
{
    ...
    public static class Lib
    {
        ...
        public static extern bool StartRTSPStream(int id, string rtspURL, int target_fps);

        [DllImport(name, EntryPoint = "StartRTSPStreamWithRes")]
        public static extern bool StartRTSPStreamWithRes(int id, string rtspURL, int target_fps, int width, int height);
